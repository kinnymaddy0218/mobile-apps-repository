...
const CategoryMixChart = nextDynamic(() => import('@/components/Portfolio/CategoryMixChart'), { 
    ssr: false,
    loading: () => <div className="animate-pulse bg-slate-800/50 rounded-full h-[300px] w-[300px] mx-auto" />
});
        ...
        <div className="portfolio-container">
            ...
            <footer className="mt-4 py-8 border-t border-primary text-center">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 opacity-30 group hover:opacity-100 transition-opacity">
                    ...
                    <span className="text-[8px] font-mono tracking-tighter text-slate-500 uppercase">Institutional Sync ID: v2.1-COLLECTIVE-RECOVERY</span>
